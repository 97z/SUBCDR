...
def data_preparation(config, dataset):
    ...
    if dataloaders is not None:
        ...
        source_train_dataset, source_valid_dataset, source_test_dataset,target_train_dataset, \
        ...
        if source_valid_dataset is not None:
            #source_train_sampler, source_valid_sampler, source_test_sampler = create_samplers(config, dataset.source_domain_dataset, built_datasets[:3])
            ...
            #source_valid_data = get_dataloader(config, 'evaluation', 'source')(config, source_valid_dataset, source_valid_sampler, shuffle=False)
