...
def init():
    ...
    parser.add_argument('--domain', default='Cell', type=str, help='Movie/Music/Cell/Elec/Toy/Video/Electronics/Cell/Sport_before/Cloth_before/Office/Arts')
    parser.add_argument('--user_k', type=int, default=5, help='User k-core filtering')
    parser.add_argument('--item_k', type=int, default=5, help='Item k-core filtering')
    
    args = parser.parse_args()

    args.dataset = "Amazon_paper"
    # assert args.domain in ["Movie", "Music", "Cell", "Elec", "Video", "Toy"]
...
def filter(args):
    ...
    if amazon==1:
        ...
        filter_inters_new(args, rating_inters, meta_items)
    elif movielen==1:
        filter_inters_movielens(args, rating_inters)
    else:
        filter_inters_douban(args, rating_inters)
