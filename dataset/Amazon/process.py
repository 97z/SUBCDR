...
def init():
    ...
    parser.add_argument('--domains', default='Cloth-Sport', help='Movie-Music/Electronics-Cell/Toy-Video/Cloth_before-Sport_before/Office-Arts', type=str)
    parser.add_argument('--seed', default=2024, type=int)
    parser.add_argument('--neg_candidates', default=99, type=int)
    
    args = parser.parse_args()
    #改这里
    args.dataset = "Amazon_paper"
    #assert args.domains in ["Cell-Elec", "Movie-Music", "Toy-Video", "Electronics-Cell", "Cloth_before-Sport_before"]
